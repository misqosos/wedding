...
<div class="frame-mitko">
    ...
    <div class="form-mitko evaluation" style="display: none;" id="not-all-correct">
        ...
        <p>
            Gratulujem! <br><br>
            <label id="corrects-amount"></label> <br><br>
    ...
    <div class="home-button">
        <a href="/m" style="display: flex; align-items: center; color: inherit; text-decoration: none; -webkit-text-stroke-color: inherit">
