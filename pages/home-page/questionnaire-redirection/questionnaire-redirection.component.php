...
<div class="collection-wrapper bottom-right">
    ...
    <a href="/michal" style="display: flex;"><img src="assets/images/mitko.png" alt="Mitko" class="person"></a>
</div>
...
<div class="collection-wrapper bottom-left">
    ...
    <a href="/domka" style="display: flex;"><img src="assets/images/domka.png" alt="Mitko" class="person"></a>
</div>
